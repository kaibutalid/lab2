...
<body>
        ...
        <div class="test">
            ...
            <div class="txtbox-3">
                ...
                <button onClick="play_sound(this.id)">
                    <img  id="shop" src="3.png" class="circle-image" onClick="toggle()">
                </button>
                <button onClick="play_sound(this.id)">
                    <img  id="music" src="4.png" class="circle-image" onClick="msg()">
                </button>
                <button onClick="play_sound(this.id)">
                    <img  id="book" src="5.png" class="circle-image">
                </button>
                <button onClick="play_sound(this.id)">
                    <img  id="makeup" src="6.png" class="circle-image">
                </button>
                <button onClick="play_sound(this.id)">
                    <img  id="starfish" src="7.png" class="circle-image">
                </button>
            </div>
        </div>
    </section>
    ...
    <footer id="section3">
        <div class="txtbox-ftr">
            <div class="ftr">
                <p style="color: white; font-size: 20px; font-weight: bolder; text-align: right;">Interested?<br>You can find me here!</p>
                <ul class="ftr-links">
                    <li><a href="https://www.linkedin.com/in/kai-a-butalid-0b90261b3/">LinkedIn</a></li>
                    <li><a href="https://github.com/kaibutalid">Github</a></li>
                    <li><a href="https://www.facebook.com/profile.php?id=100013608332386">Facebook</a></li>
                    <li><a href="https://www.instagram.com/qaibtd/">Instagram</a></li>
                </ul>
            </div>
        </div>
    </footer>
