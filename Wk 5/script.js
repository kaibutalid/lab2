// Automatically active link once loaded
...
function setActiveLink() {
    ...
    links.forEach(function(link) {
        if (link.href === currentPage || currentPage.endsWith(link.getAttribute('href'))) {
...
var prevScrollpos = window.pageYOffset;
        ...
        window.onscroll = function() {
            ...
            if (prevScrollpos > currentScrollPos) {
                ...
                document.getElementById("site-header").style.top = "-110px";
            }
